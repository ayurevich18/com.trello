...
public void loginAPI() throws IOException {
   ...
   String c=response3.headers().get("Set-Cookie");
   System.out.println(c);
   String cookie=c.substring(0,c.indexOf(";"));
   System.out.println(cookie);
    ...
    String helloMsg = "method=password&factors%5Buser%5D=aleksej.yurevich%40gmail.com&factors%5Bpassword%5D=12345678q&castleClientId=fc3fea79-3694-40f5-8880-907c5aa2c2b6-af7e0e1eb84f131a4dbce0bd";
    ...
    System.out.println("dd"+response.headers("Set-Cookie"));
